...
This section provides benchmarks for the `udecimal` library in comparision with [shopspring/decimal](https://github.com/shopspring/decimal). The results are for references and can be varied depending on the hardware.
...
Div/1234567890123456789.1234567890123456879.Div(9876543210987654321.1234567890123456789)-32    489.35n ± 22%   16.85n ±  4%  -96.56% (p=0.000 n=10)
